...
main_purpose    = str(input("Enter the purpose: \n"))
user_function   = str(input("and objective function: \n"))

#2x_1 + 3x_2
objective = (main_purpose, user_function)

n = int(input("Please, enter number of constraints: \n"))
constraints = list()
for i in range(n) :
    constraints.append(str(input("Enter the purpose: \n")))

#constraints = ['1x_1 + 5x_2 >= 10', '3x_1 + 2x_2 >= 12', '2x_1 + 4x_2 >= 16', '2x_1 + 2x_2 >= 10', '1x_1 >= 1']
Lp_system = Simplex(num_vars=2, constraints=constraints, objective_function=objective)

print("\nResult of simplex method solving linear programming task is : \n")

for key in Lp_system.solution:
    print(key, '->', Lp_system.solution[key])

print("Value of objective function with calculated mixtures proportions")
